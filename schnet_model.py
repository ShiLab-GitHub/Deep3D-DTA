...
class SchNet(torch.nn.Module):
    ...
    def __init__(self, energy_and_force=False, out_channels=31, cutoff=10.0, num_layers=6, hidden_channels=128, num_filters=128,
             num_gaussians=50):
    ...
    def forward(self, z1, pos1, batch):
        z, pos, batch = z1, pos1, batch
